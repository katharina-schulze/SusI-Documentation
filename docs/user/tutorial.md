...
### Easy Example
For this Tutorial we have created an [easy example code](https://github.com/KatLily-74656/viplab-example-docker), that just outputs information that was passed to the script using an INI-file and a C-file. 
...
!!! tip inline end
    Remember to move to the correct directory using `cd [path-to-directory]/viplab-example-docker`, meaning the freshly cloned [example-repository](https://github.com/KatLily-74656/viplab-example-docker)!
